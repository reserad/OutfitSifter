...
public class cam_shirt extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shirt_cam);
		...
		final ToggleButton sleeveToggle = (ToggleButton)findViewById(R.id.btnLongToggle);
		final ToggleButton flashToggle = (ToggleButton)findViewById(R.id.btnFlash2);
		sleeveToggle.setText(null);
		sleeveToggle.setTextOn(null);
		sleeveToggle.setTextOff(null);
		sleeveToggle.setChecked(false);
		...
		preview.setOnTouchListener(new SurfaceView.OnTouchListener(){
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				final ImageView iv = new ImageView(cam_shirt.this);
		...
		sleeveToggle.setOnClickListener(new Button.OnClickListener(){
			public void onClick(View arg0) {
				sleeveToggle.toggle();
				final ImageView item = (ImageView)findViewById(R.id.header);

				if (sleeveToggle.isChecked() == false){
					sleeveToggle.setChecked(true);

					//item.setImageResource(R.drawable.longShirt);
					Toast.makeText(context, "Long sleeve shirt selected", Toast.LENGTH_SHORT).show();
				}else{
					sleeveToggle.setChecked(false);
					Toast.makeText(context, "Short sleeve shirt selected", Toast.LENGTH_SHORT).show();
					item.setImageResource(R.drawable.shirt);
					//checked = false;
				}
	...
	PictureCallback myPictureCallback_JPG = new PictureCallback(){
		...
		class SavePhotoTask extends AsyncTask<byte[], String, String> {
			...
			protected String doInBackground(byte[]... png) {
				File d = new File(Environment.getExternalStorageDirectory() + "/OutfitSifter/" + UserName + "/" + pathExtension + "shirts/");
				ToggleButton sleeveToggle = (ToggleButton)findViewById(R.id.btnLongToggle);
				if(sleeveToggle.isChecked() == true){
					d = new File(Environment.getExternalStorageDirectory() + "/OutfitSifter/" + UserName + "/" + pathExtension + "Lshirts/");
				}
		...
		AutoFocusCallback myAutoFocusCallback = new AutoFocusCallback(){
			...
			private void initPreview(int width, int height) {
				if (camera != null && previewHolder.getSurface() != null)
                {
                    ...
                    {
						Toast.makeText(cam_shirt.this, t.getMessage(),
